{
	"translatorID": "RUSSIAN0-0BIB-TEX0-V002-CITEKEY00000",
...
var exportLocalFilePath = false // default=no
var preserveLatex = false // default=no
// -- Tan --end
...
function processField(item, field, value) {
	...
	if(fieldMap[field]) {
		...
		// Ivan Denisov. This system is not working yet
		if (city2map[value]) {
			item.place = city2map[value];
		} else {
			item.place = value
		}
